...
function droneDirection(input) {
  ...
  //Clockwise direction
  if (direction === "N" && directions[0] === "R") {
    return (direction = "E");
  }
  if (direction === "E" && directions[0] === "R") {
    return (direction = "S");
  }
  if (direction === "S" && directions[0] === "R") {
    return (direction = "W");
  }
  if (direction === "W" && directions[0] === "R") {
    return (direction = "N");
  }
  //Anticlockwise direction
  if (direction === "N" && directions[0] === "L") {
    return (direction = "W");
  }
  if (direction === "W" && directions[0] === "L") {
    return (direction = "S");
  }
  if (direction === "S" && directions[0] === "L") {
    return (direction = "E");
  }
  if (direction === "E" && directions[0] === "L") {
    return (direction = "N");
  }
